<template>
    <div class="q-pa-md">
    <q-btn @click="EntrezBloodPre" color="blue" label="Entrez les valeurs"/> 
        <table 
          ...
          <tbody  :style="{ backgroundColor:`${flagColor}`, color:'white', size:'14px' }" class="tw-divide-y tw-divide-gray-200">
            <tr class="tw-divide-x tw-divide-gray-200">
              <td class="text-h6">Bras Gauche</td>
            ...
            <tr class="tw-divide-x tw-divide-gray-200">
              <td class="text-h6">Bras Droit</td>
              <td class="tw-text-center text-bold">
        ...
        <q-btn @click="next" label="Suivant" color="blue"/> 
        </div>
     </div>
      <base-dialog
      ...
      <div class="tw-flex tw-justify-left">
       ...
       <p>Bras Droit</p>
        ...
        <q-btn @click="submit" class="tw-mt-4 tw-mr-5 " label="Submit" color="blue"/>
        </div>
      </base-dialog>
</template>
